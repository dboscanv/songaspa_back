...
(function($) {
 ...
 // DOM Content Load Event Actions;
  ...
  $('#typeText').typed({
    strings: ['Front-end developer(Html5,Css3,Js){<br> Bootstrap(Html5,Css3);<br>AngularJs(Js);<br>}<br>'+
      'Back-end developer(Java,Php,NodeJs){<br>JavaEE(Java,RestFul;)<br>Php(Codeigniter,Laravel,Restful);<br>NodeJs(Express,RestFul);<br>}}'],
    typeSpeed: 150,
    loop: false
  });
